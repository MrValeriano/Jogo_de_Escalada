...
fonts = {
    ...
    "HUD_moedas": pygame.font.Font(join("Grafismos", "minecraftia", "Minecraftia-Regular.ttf"), 35),
    "HUD_vidas": pygame.font.Font(join("Grafismos", "minecraftia", "Minecraftia-Regular.ttf"), 35)
}